    ...
    <div class="container">
        <div class="row partition2">
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-right text-center">
                        <img src="{{ url('/') }}/assets/images/sub-banner1.jpg" class="img-fluid" alt="">
            ...
            <div class="col-md-6">
                <a href="#">
                    <div class="collection-banner p-right text-center">
                        <img src="{{ url('/') }}/assets/images/sub-banner2.jpg" class="img-fluid" alt="">
                        <div class="contain-banner">
                            <div>
                                <h4>save 60%</h4>
                                <h2>women</h2>
                ...
                <div class="product-4 product-m no-arrow">
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="{{ url('/') }}/assets/images/pro3/27.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(no-sidebar).html"><img src="{{ url('/') }}/assets/images/pro3/28.jpg" class="img-fluid" alt=""></a>
                            </div>
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <!-- front image -->
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="{{ url('/') }}/assets/images/pro3/1.jpg" class="img-fluid" alt=""></a>
                            </div>

                            <!-- hover back image -->
                            <div class="back">
                                <a href="product-page(no-sidebar).html"><img src="{{ url('/') }}/assets/images/pro3/2.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button  title="Add to cart"><i class="icon-shopping-cart" ></i></button>
                                <a href="javascript:void(0)"  title="Add to Wishlist"><i class="icon-heart" aria-hidden="true"></i></a>
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="{{ url('/') }}/assets/images/pro3/33.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(no-sidebar).html"><img src="{{ url('/') }}/assets/images/pro3/34.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button  title="Add to cart"><i class="icon-shopping-cart" ></i></button>
                                <a href="javascript:void(0)"  title="Add to Wishlist"><i class="icon-heart" aria-hidden="true"></i></a>
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            <div class="front">
                                <a href="product-page(no-sidebar).html"><img src="{{ url('/') }}/assets/images/pro3/35.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="back">
                                <a href="product-page(no-sidebar).html"><img src="{{ url('/') }}/assets/images/pro3/36.jpg" class="img-fluid" alt=""></a>
                            </div>
                            <div class="cart-info cart-wrap">
                                <button  title="Add to cart"><i class="icon-shopping-cart" ></i></button>
                                <a href="javascript:void(0)"  title="Add to Wishlist"><i class="icon-heart" aria-hidden="true"></i></a>
            ...
            <div class="col-md-12">
                <div class="slide-3 no-arrow">
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <img src="{{ url('/') }}/assets/images/blog/1.jpg" class="img-fluid" alt="">
                                <span></span>
                            </div>
                        </a>
                        <div class="blog-details">
                            <h4>25 January 2018</h4>
                            <a href="#"><p>Lorem ipsum dolor sit consectetur adipiscing elit, </p></a>
                            <hr class="style1">
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <img src="{{ url('/') }}/assets/images/blog/2.jpg" class="img-fluid" alt="">
                                <span></span>
                            </div>
                        </a>
                        <div class="blog-details">
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <img src="{{ url('/') }}/assets/images/blog/3.jpg" class="img-fluid" alt="">
                                <span></span>
                            </div>
                        </a>
                        <div class="blog-details">
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <img src="{{ url('/') }}/assets/images/blog/4.jpg" class="img-fluid" alt="">
                                <span></span>
                            </div>
                        </a>
                        <div class="blog-details">
                    ...
                    <div class="col-md-12">
                        <a href="#">
                            <div class="classic-effect">
                                <img src="{{ url('/') }}/assets/images/blog/5.jpg" class="img-fluid" alt="">
                                <span></span>
                            </div>
                        </a>
                        <div class="blog-details">
            ...
            <div class="col-md-12 p-0">
                ...
                <div class="slide-7 no-arrow slick-instagram">
                    <div>
                        <a href="#">
                            <div class="instagram-box">
                                <img src="{{ url('/') }}/assets/images/slider/2.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay">
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box">
                                <img src="{{ url('/') }}/assets/images/slider/3.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay">
                                    <i class="fa fa-instagram"  aria-hidden="true"></i>
                                </div>
                            </div>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box">
                                <img src="{{ url('/') }}/assets/images/slider/4.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay">
                                    <i class="fa fa-instagram"  aria-hidden="true"></i>
                                </div>
                            </div>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box">
                                <img src="{{ url('/') }}/assets/images/slider/9.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay">
                                    <i class="fa fa-instagram"  aria-hidden="true"></i>
                                </div>
                            </div>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box">
                                <img src="{{ url('/') }}/assets/images/slider/6.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay">
                                    <i class="fa fa-instagram"  aria-hidden="true"></i>
                                </div>
                            </div>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box">
                                <img src="{{ url('/') }}/assets/images/slider/7.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay">
                                    <i class="fa fa-instagram"  aria-hidden="true"></i>
                                </div>
                            </div>
                    ...
                    <div>
                        <a href="#">
                            <div class="instagram-box">
                                <img src="{{ url('/') }}/assets/images/slider/8.jpg" alt="Avatar" style="width:100%">
                                <div class="overlay">
                                    <i class="fa fa-instagram"  aria-hidden="true"></i>
                                </div>
                            </div>
                ...
                <div class="slide-6 no-arrow">
                    <div>
                        <div class="logo-block">
                            <a href="#">
                                <img src="{{ url('/') }}/assets/images/logos/1.png" alt="">
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#">
                                <img src="{{ url('/') }}/assets/images/logos/2.png" alt="">
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#">
                                <img src="{{ url('/') }}/assets/images/logos/3.png" alt="">
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#">
                                <img src="{{ url('/') }}/assets/images/logos/4.png" alt="">
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#">
                                <img src="{{ url('/') }}/assets/images/logos/5.png" alt="">
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#">
                                <img src="{{ url('/') }}/assets/images/logos/6.png" alt="">
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#">
                                <img src="{{ url('/') }}/assets/images/logos/7.png" alt="">
                            </a>
                        </div>
                    </div>
                    <div>
                        <div class="logo-block">
                            <a href="#">
                                <img src="{{ url('/') }}/assets/images/logos/8.png" alt="">
                            </a>
                        </div>
                    </div>
                </div>
