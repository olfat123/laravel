                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="footer-contant">
                        <div class="footer-logo">
                            <img src="{{ url('/') }}/assets/images/icon/logo.png" alt="">
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-md-6 col-sm-12">
                    <div class="payment-card-bottom">
                        <ul>
                            <li>
                                <a href="#"><img src="{{ url('/') }}/assets/images/icon/visa.png" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ url('/') }}/assets/images/icon/mastercard.png" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ url('/') }}/assets/images/icon/paypal.png" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ url('/') }}/assets/images/icon/american-express.png" alt=""></a>
                            </li>
                            <li>
                                <a href="#"><img src="{{ url('/') }}/assets/images/icon/discover.png" alt=""></a>
                            </li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="modal-bg">
                                ...
                                <div class="offer-content">
                                    <img src="{{ url('/') }}/assets/images/Offer-banner.png" class="img-fluid" alt="">
                                    <h2>newsletter</h2>
                                    <form>
                ...
                <div class="row">
                    <div class="col-lg-6  col-xs-12">
                        <div class="quick-view-img">
                            <img src="{{ url('/') }}/assets/images/pro3/1.jpg" alt="" class="img-fluid">
                        </div>
                    </div>
...
js.src ={{ url('/') }}../../../connect.facebook.net/en_US/sdk/xfbml.customerchat.js#xfbml=1&version=v2.12&autoLogAppEvents=1';
