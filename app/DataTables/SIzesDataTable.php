...
class SizesDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('edit', '<a href="/admin/sizes/{{$id}}/edit" class="btn btn-info"><i class="fa fa-edit"></i></a>')
    ...
    {
        return $model->newQuery()->select('id', 'size_name_ar', 'size_name_en', 'created_at', 'updated_at');
    }
                   ...
                   // ->addAction(['width' => '80px'])
                    ...
                    ->parameters([
                        ...
                        'buttons'      => [
                            ...
                            ['text' => '<i class="fa fa-plus"></i>  Add Size ','className' =>'btn btn-info','action'=>"function(){
